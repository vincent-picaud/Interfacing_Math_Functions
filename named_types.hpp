...
namespace Optimize
{
  ...
  //
  using Maximum_Iterations = OptionalArgument::Named_Type<struct Maximum_Iterations_Tag, size_t>;
  static constexpr auto _maximimum_iterations_ =
      typename Maximum_Iterations::argument_syntactic_sugar();

  //////////////// Verbose ////////////////
  //
  using Verbose                   = OptionalArgument::Named_Type<struct Verbose_Tag, bool>;
  ...
  //
  using Relative_Epsilon = OptionalArgument::
  ...
  //
  using Absolute_Epsilon = OptionalArgument::
